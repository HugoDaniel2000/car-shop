...
import { validMotorcycle } from '../../mocks/motocyclesMocks';
...
describe('Motorcycles Controller', () => {
  let controller = new MotorcycleController();
  ...
  describe('create', () => {
    ...
    before(async () => {
      ...
      createStub = sinon.stub(MotorcycleService.prototype, 'create');
    });
    ...
    it('Should return 201', async () => {
      ...
      expect((res.json as SinonStub).calledWith(validMotorcycle)).to.be.equal(true)
    });
  ...
  describe('readOne', () => {
    ...
    before(async () => {
      ...
      readOne = sinon.stub(MotorcycleService.prototype, 'readOne');
    });
    ...
    it('Should return 200', async () => {
      readOne.resolves(validMotorcycle)
      req2.params = {id: "3"}
  ...
  describe('read', () => {
    ...
    before(async () => {
      ...
      readOne = sinon.stub(MotorcycleService.prototype, 'read');
    });
  ...
  describe('update', () => {
    ...
    before(async () => {
      ...
      readOne = sinon.stub(MotorcycleService.prototype, 'update');
    });
  ...
  describe('delete', () => {
    ...
    before(async () => {
      ...
      readOne = sinon.stub(MotorcycleService.prototype, 'delete');
    });
  ...
  describe('test route', () => {
    it('should to be "/Motorcycles', () => {
      expect(controller.route).to.be.eql('/Motorcycles')
    })
  })
